<%@ page title="Customerwise Due Date Alter List" language="C#" masterpagefile="~/AdminPage.master" autoeventwireup="true" inherits="rptCusDueAlert, App_Web_saitqoye" enableeventvalidation="false" %>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:SqlDataSource ID="sDsCusDueAlert" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStrErp %>"
                                                    SelectCommand="SELECT City , Capacity,convert(varchar,[ClnDate] ,103) as Reg_Date ,convert(varchar,NxtDueDate,103) as mDate,[cTypes] as Type ,[cName],[Name],[Cell] ,Address FROM [vwCustomerAlert] where MONTH(NxtDueDate) = MONTH(GETDATE()) order by ClnDate,cTypes">
                                                </asp:SqlDataSource>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
