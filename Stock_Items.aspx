<%@ page language="C#" autoeventwireup="true" inherits="Stock_Items, App_Web_fa4yg0ar" %>
    ...
    <div class="page">
        ...
        <div class="main">
            <fieldset id="fldStream" style="border: 1px solid #006600; width: 70.5%; margin-left: 170px;
                margin-top: 30px;">
                <legend><span class="spanCss">Equipment Details</span></legend>
                <div>
                            ...
                            <td>
                                <div align="center" style="padding: 5px;">
                                    <table cellpadding="0" cellspacing="5" style="border: solid 2px #b7ddf2; background: #ebf4fb;
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblCaption0" runat="server" Text="Items *" Width="120px"></asp:Label>
                                                <asp:TextBox ID="txtItems" runat="server" CssClass="validate[required]" 
                                                    Width="450px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblCaption1" runat="server" Text="Price *" Width="120px"></asp:Label>
                                                <asp:TextBox ID="txtPrice" runat="server" CssClass="validate[required,custom[number]] text-input"
                                                   style="font-weight:bold;text-align:right;"  Width="100px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblCaption3" runat="server" Text="VAT % *" Width="120px"></asp:Label>
                                                <asp:DropDownList ID="ddlVat" runat="server" Width="105px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblCaption2" runat="server" Text="Type *" Width="120px"></asp:Label>
                                                <asp:DropDownList ID="ddleTypes" runat="server" Width="105px">
